...
//	NSRange rang = [string rangeOfString:@"<head>"];
//	if (rang.location > 0 && rang.location < [string length]) {
//		DebugLog(@"%@",string);
...
//		[tabbarController.view addSubview:webView];
//		[tabbarController.presentedViewController.view addSubview:webView];
//
//	}
//	
//	[string release];
